...
function install(){
 const form=document.getElementById('saleForm'),paid=document.getElementById('salePaid');
 ...
 function apply(){const total=net();if(method.value==='cash')paid.value=String(total);else if(method.value==='credit')paid.value='0';paid.readOnly=method.value!=='partial';if(typeof updateSaleTotals==='function')updateSaleTotals()}
